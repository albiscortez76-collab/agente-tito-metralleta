...
/**
 * Banner de alertas de Financial Juice para el ticker activo. Poll simple (no
 * SSE): un titular de mercado no necesita latencia de milisegundos, y así el
 * monitor (proceso aparte) no tiene que mantener conexiones abiertas por cliente.
 */
  ...
  return (
    <div className="card news-alert-banner" role="alert">
      ...
      <div className="news-alert-body">
        <div className="news-alert-title">Financial Juice — mención de {alert.ticker}</div>
